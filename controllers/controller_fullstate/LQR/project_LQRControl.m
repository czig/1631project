...
% pos_z_wght        = 0.1/3;
% 
% orient_ypr_wghts  = 0.25/3;  %weights for each of the three angles of orientations(attitude) (was 0.25)
% 
% dpos_wghts        = 0.05/3; %weights for each of the three velocities of position
% 
% dorient_pqr_wghts = 0.6/3; %weights for each of the three angular rates of orientations(attitude) (was 0.6)
% 
% rho = 15;
...
% pos_z_wght        = 0.1/3;
% 
% orient_ypr_wghts  = 0.15/3;  %weights for each of the three angles of orientations(attitude) (was 0.25)
% 
% dpos_wghts        = 0.05/3; %weights for each of the three velocities of position
% 
% dorient_pqr_wghts = 0.05/3; %weights for each of the three angular rates of orientations(attitude) (was 0.6)
% 
% rho = 20;

%% Cost weights on states - faster control
% For simulation
%pos_x_wght        = 0.1/3;  % originally 0.1/3
%pos_y_wght        = 0.1/3;
%pos_z_wght        = 0.3/3;
% 
...
pos_x_wght        = 0.1/3;  % originally 0.1/3
pos_y_wght        = 0.05/3;
pos_z_wght        = 0.15/3; % somewhere between 0.1/3 and 0.2/3
